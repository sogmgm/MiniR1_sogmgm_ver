...
##### 성능 (A100 80GB, 1035 steps)

**학습 진행에 따른 주요 지표 변화** (5개 구간으로 분할 분석):
...
- 📊 **Overall Reward**: 41% 상승으로 전반적 품질 개선 확인

**주의사항**: 구간5(801-1035)에서 Equation Reward가 0.514로 소폭 하락(-15%) → 과적합 또는 탐색 부족 가능성. Checkpoint 800 근처가 최적일 수 있음.
